                    ...
                    <ChoiceGrid>
                        <ChoiceCard>
                            <CardHeader>
                                ...
                                <CardTitle>Peak Browser</CardTitle>
                            </CardHeader>
                            <CardDescription>
                                A native Apple browser workspace. Search, save, plan, draw, ask AI, and collaborate nearby from one calm command surface.
                            </CardDescription>
                            <FeatureList>
                                <li><Zap /> Native SwiftUI &amp; WebKit</li>
                                <li><Monitor /> Notes, Tasks &amp; Whiteboards</li>
                                <li><Library /> Local-First &amp; Private</li>
